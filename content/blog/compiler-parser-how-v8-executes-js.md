---
title: "编译器和解析器：V8是如何执行一段JavaScript代码的"
description: "前面我们已经花了很多篇幅来介绍 JavaScript 是如何工作的，了解这些内容能帮助你从底层理解 JavaScript 的工作机制，从而能帮助你更好地理解和应用 JavaScript。 今天这篇文章我们就继续\"向下\"分析，站在 JavaScript 引擎 V8 的视角，来分析 JavaScrip..."
date: "2024-02-11"
author: "Kerwin"
tag: "Frontend"
---
...
![编译器和解释器翻译代码](/images/browser/compiler-parser-how-v8-executes-js/translate-code.png)
...
![V8执行一段代码流程图](/images/browser/compiler-parser-how-v8-executes-js/v8-execute-code-process.png)
...
![ast结构图](/images/browser/compiler-parser-how-v8-executes-js/ast-structure.png)
...
![分解token示意图](/images/browser/compiler-parser-how-v8-executes-js/token-sketch.png)
...
![字节码和机器码占用空间对比](/images/browser/compiler-parser-how-v8-executes-js/bytecode-machinecode-contrast.png)
...
![JIT的工作过程](/images/browser/compiler-parser-how-v8-executes-js/jit-process.png)
