...
description: "在上篇文章中，我们介绍了怎么使用 Promise 来实现回调操作，使用 Promise 能很好地解决回调地狱的问题，但是这种方式充满了 Promise 的 then() 方法，如果处理流程比较复杂的话，那么整段代码将充斥着 then，语义化不明显，代码不能很好地表示执行流程。 比如下面这样一个实际..."
date: "2024-03-01"
author: "Kerwin"
tag: "Frontend"
---
...
![协程执行流程图](/images/browser/async-await-sync-way-to-write-async-code/coroutine-execute-process.png)
...
![gen协程和父协程之间的切换](/images/browser/async-await-sync-way-to-write-async-code/coroutine-switch.png)
...
![async/await执行流程图](/images/browser/async-await-sync-way-to-write-async-code/async-await-execute-process.png)
