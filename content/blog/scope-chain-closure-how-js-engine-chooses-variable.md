...
description: "理解作用域链是理解闭包的基础，而闭包在 JavaScript 中几乎无处不在，同时作用域和作用域链还是所有编程语言的基础。所以，如果你想学透一门语言，作用域和作用域链一定是绕不开的。 那今天我们就来聊聊什么是作用域链，并通过作用域链再来讲讲什么是闭包。 首先我们来看下面这段代码： ```js..."
date: "2024-01-29"
author: "Kerwin"
tag: "Frontend"
---
...
![bar调用栈](/images/browser/scope-chain-closure-how-js-engine-chooses-variable/bar-call-stack.png)
...
![outer指向](/images/browser/scope-chain-closure-how-js-engine-chooses-variable/outer-point.png)
...
![词法作用域链](/images/browser/scope-chain-closure-how-js-engine-chooses-variable/lexical-scope-chain.png)
...
![调用栈](/images/browser/scope-chain-closure-how-js-engine-chooses-variable/call-stack.png)
...
![foo调用栈](/images/browser/scope-chain-closure-how-js-engine-chooses-variable/foo-call-stack.png)
...
![foo执行完的调用栈](/images/browser/scope-chain-closure-how-js-engine-chooses-variable/foo-execute-call-stack.png)
...
![setName的调用栈](/images/browser/scope-chain-closure-how-js-engine-chooses-variable/setName-call-stack.png)
...
![Chrome调试工具](/images/browser/scope-chain-closure-how-js-engine-chooses-variable/chrome-tool-closure.png)
