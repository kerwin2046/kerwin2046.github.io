...
description: "浏览器安全主要划分为三大块内容：页面安全、系统安全和网络安全。前面我们用四篇文章介绍了页面安全和系统安全，也聊了浏览器和 Web 开发者是如何应对各种类型的攻击，本文是我们专栏的最后一张，我们就接着聊聊网络安全协议 HTTPS。 我们先从 HTTP 的明文传输的特性讲起，在上一个模块的三篇文章中我..."
date: "2024-04-22"
author: "Kerwin"
tag: "DevOps"
---
...
![中间人攻击](/images/browser/https-make-data-transmission-secure/man-in-the-middle-token-attack.png)
...
![HTTP VS HTTPS](/images/browser/https-make-data-transmission-secure/http-vs-https.png)
...
![对称加密](/images/browser/https-make-data-transmission-secure/symmetrical-encryption.png)
...
![非对称加密](/images/browser/https-make-data-transmission-secure/asymmetric-encryption.png)
...
![对称加密和非对称加密搭配使用](/images/browser/https-make-data-transmission-secure/symmetrical-asymmetric-encryption.png)
...
![含有数字证书的HTTPS请求流程](/images/browser/https-make-data-transmission-secure/digital-certificate.png)
