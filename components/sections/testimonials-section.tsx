      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 pt-4 md:pt-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-[1.3]">
            {t("heading")}
            <br />
            {t("headingBreak")} <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">{t("headingHighlight")}</span>
          </h2>
          ...
          <div className="relative">
            <div className="bg-white border-4 border-black rounded-3xl py-8 md:py-14 px-6 md:px-8 md:pr-72 lg:pr-72">
              ...
              <div className="md:max-w-[65%]">
                ...
                <div>
                  <div className="font-bold text-base md:text-lg">{t("authorName")}</div>
                  <div className="text-gray-600 text-sm md:text-base">{t("authorRole")}</div>
                </div>
              </div>
            </div>
