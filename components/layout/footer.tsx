import { Facebook, Twitter, Instagram, Youtube, Linkedin, Mail, Github } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 mb-12">
            <div>
              ...
              <div className="flex gap-3">
                <a href={siteConfig.links.github} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#2F81F7] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="GitHub">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><Link href="/#portfolio" className="hover:text-white transition-colors">{tNav("portfolio")}</Link></li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>{siteConfig.name} · {t("copyright")} · {t("authorLocale")}</p>
          </div>
        </div>
      </div>
    </footer>
